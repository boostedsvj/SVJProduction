...
_helper = svjHelper()
_helper.setModel(options.channel,options.mMediator,options.mDark,options.rinv,options.alpha,generate=not options.madgraph,boost=options.boost,mingenjetpt=options.mingenjetpt,yukawa=options.yukawa)
